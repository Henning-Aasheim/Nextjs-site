...
export default function Footer() {
    ...
    return (
    <footer className="text-base mt-auto px-6 py-6 text-center font-default bg-cyan dark:bg-cyan/60">
                ...
                <div className="inline-block lg:col-span-2">
                    <div className="mb-4 text-left">
                        <div className="inline-block align-middle">
                            <img src='/profile_image.jpg' className="w-12 h-12 object-cover rounded-full mx-auto border-white/60 border"></img>
                        </div>
