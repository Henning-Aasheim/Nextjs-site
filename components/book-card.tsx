...
import { formatBookYear, DateTranslator } from '@/app/lib/yearFormat'
...
export function BookCard({
  ...
  const yearLabel = formatBookYear(tDate, { year: book.year, yearRange: book.yearRange })
    ...
    <div className="group">
      <div
        className="
          ...
          dark:hover:bg-black overflow-hidden
